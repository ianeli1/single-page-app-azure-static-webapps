(() => {
  ...
  const n = "https://rickandmortyapi.com/api/character/",
    ...
    e = () => location.hash.slice(1).toLocaleLowerCase().split("/")[1] || "/",
    t = () =>
...
async function Main(){
    ...
    const request = await fetch("/api/getSaludo")
    const json = await request.json()
    header.innerHTML = json.text ?? "Not found"
